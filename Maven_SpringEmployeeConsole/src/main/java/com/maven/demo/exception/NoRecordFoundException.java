...
public class NoRecordFoundException extends Exception {
	...
	public NoRecordFoundException(String errorMsg, String objectType, String queryType, String userInputValue) {
		super();
	...
	public String toString() {
		return ("No " + objectType + " found [" + queryType + " = " + userInputValue +"]");
	}
