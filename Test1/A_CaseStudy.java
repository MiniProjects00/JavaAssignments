...
/*
		...
		---------------------------------------------------------------
		Create your program according to the following specifications:
		---------------------------------------------------------------
		...
		B)	public int getTotalOrderCost(String category)throws InvalidCategryException;
		  	...
		  	-> Method should return the total value of the order based on category and action should 
		  	   be only delivered
		...
		g) 	public boolean generatePDFReports(); 
		   	...
		   	-> method will count the number of orders based on cash payment , online payment and unpaid 
